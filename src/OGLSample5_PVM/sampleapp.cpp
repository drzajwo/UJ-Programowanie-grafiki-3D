...
SampleApp::SampleApp() : OGLAppFramework::OGLApplication(1366u, 768u, "OGLSample 5", 3u, 3u), simple_program(0u), vbo_handle(0u), index_buffer_handle(0u), vao_handle(0u)
{
}
...
//    gl::glCullFace(gl::GL_BACK);
    ...
    glm::mat4 View = glm::lookAt(glm::vec3(3.f,2.5f,2.0f), glm::vec3(0,0,0), glm::vec3(0,0,1));
